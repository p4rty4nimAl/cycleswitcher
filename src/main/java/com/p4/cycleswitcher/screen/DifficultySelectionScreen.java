...
public class DifficultySelectionScreen
    ...
    private static final Text SELECT_NEXT_TEXT = new TranslatableText("debug.difficulties.select_next", new TranslatableText("debug.difficulties.press_f7").formatted(Formatting.AQUA));
    ...
    protected void init() {
        super.init();
        this.weather = this.currentWeather.isPresent() ? this.currentWeather : WeatherSelection.of(client.world.getDifficulty() == Difficulty.byName("peaceful") ? WeatherSelection.PEACEFUL : client.world.getDifficulty() == Difficulty.byName("easy") ? WeatherSelection.EASY : client.world.getDifficulty() == Difficulty.byName("normal") ? WeatherSelection.NORMAL : WeatherSelection.HARD);
    ...
    private static void apply(MinecraftClient client, Optional<WeatherSelection> weather) {
        ...
        Optional<WeatherSelection> optional = WeatherSelection.of(client.world.getDifficulty() == Difficulty.byName("peaceful") ? WeatherSelection.PEACEFUL : client.world.getDifficulty() == Difficulty.byName("easy") ? WeatherSelection.EASY : client.world.getDifficulty() == Difficulty.byName("normal") ? WeatherSelection.NORMAL : WeatherSelection.HARD);
    ...
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        if (keyCode == GLFW.GLFW_KEY_F7 && this.weather.isPresent()) {
    ...
    enum WeatherSelection {
        PEACEFUL(new TranslatableText("difficulty.peaceful"), "/difficulty peaceful", new ItemStack(Items.IRON_HOE)),
        EASY(new TranslatableText("difficulty.easy"), "/difficulty easy", new ItemStack(Items.WOODEN_SWORD)),
        NORMAL(new TranslatableText("difficulty.normal"), "/difficulty normal", new ItemStack(Items.COOKED_BEEF)),
        HARD(new TranslatableText("difficulty.hard"), "/difficulty hard", new ItemStack(Blocks.SKELETON_SKULL));
    ...
    public class ButtonWidget extends ClickableWidget {
        ...
        public void renderButton(MatrixStack matrices, int mouseX, int mouseY, float delta) {
            ...
            this.weather.renderIcon(DifficultySelectionScreen.this.itemRenderer, this.x + 5, this.y + 5);
            if (this.selected) {
